...
Expanding Movie List
   ...
   ${before}=     Get Element Count  xpath://div[@class="tab-pane collapsed active"]//div[@aria-expanded="true"]/div[@class="poster-container"]
   Page Should Contain Element       xpath://img[@alt="Show more films"]
   Click Element                     xpath://img[@alt="Show more films"]
   ${after}=      Get Element Count  xpath://div[@class="tab-pane collapsed active"]//div[@aria-expanded="true"]/div[@class="poster-container"]
...
Browsing Coming Soon List
   ...
   ${coming}=     Get Element Count  xpath://div[@class="tab-pane collapsed active"]//div[@aria-expanded="true"]/div[@class="poster-container"]
